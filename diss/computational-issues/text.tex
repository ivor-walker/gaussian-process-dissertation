...
\subsubsection{Fast and exact inversions of celerite kernels}
...
Celerite representations of the kernel can be inverted using a procedure resembling Cholesky factorisation \cite{foreman-mackay}:
\begin{equation*}
    x = L^{-T}y (L^{-1} y - A^{-1} y)
\end{equation*}
